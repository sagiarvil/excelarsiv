...
- Dosya: `urunler/insaat-hakedis-santiye-maliyet/InsaatHakedisSantiyeMaliyet.xlsx`
- SHA-256: `c9f98928156ce552b8ae0ef3d97acf7a0ada8700c865003ee7525b9a5b19c16d`
- Arketip: **A3** · SPEC: `urunler/insaat-hakedis-santiye-maliyet/SPEC.yaml` (TAM)
- Tarih: 2026-08-14 21:34 · Orkestratör: kapilar.py v2.0.0 (EXCELARSİV Üretim Mandası v6.0)
...
| Ö | Dayanıklılık | TEMİZ | 0 | 3 | 53.3 | her ürün | `690aa76dda858f47` |
| D | Değer | TEMİZ | 0 | 16 | 6.5 | her ürün | `ed3f6da66984ed56` |
| M | Mevzuat | ATLANDI | 0 | 0 | 0.0 | arketip gerektirmiyor | `—` |
| E | Eşleştirme | ATLANDI | 0 | 0 | 0.0 | arketip gerektirmiyor | `—` |
| A | İş Akışı | TEMİZ | 0 | 7 | 0.3 | arketip A3 | `7c4979b5087b5847` |
