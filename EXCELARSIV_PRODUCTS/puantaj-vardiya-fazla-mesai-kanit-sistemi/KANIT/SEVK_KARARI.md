...
- Dosya: `urunler/puantaj-vardiya-fazla-mesai-kanit-sistemi/PuantajVardiyaFazlaMesaiKanitSistemi.xlsx`
- SHA-256: `f66ed3ae7090331a39d45c9372047fac3358be2e7678bff6927c356ed9e686e6`
- Arketip: **A3+A4** · SPEC: `urunler/puantaj-vardiya-fazla-mesai-kanit-sistemi/SPEC.yaml` (TAM)
- Tarih: 2026-08-11 14:36 · Orkestratör: kapilar.py v2.0.0 (EXCELARSİV Üretim Mandası v6.0)
...
| Ö | Dayanıklılık | TEMİZ | 0 | 1 | 102.8 | her ürün | `690aa76dda858f47` |
| D | Değer | TEMİZ | 0 | 16 | 28.8 | her ürün | `ed3f6da66984ed56` |
| M | Mevzuat | ATLANDI | 0 | 0 | 0.0 | arketip gerektirmiyor | `—` |
| E | Eşleştirme | ATLANDI | 0 | 0 | 0.0 | arketip gerektirmiyor | `—` |
| A | İş Akışı | TEMİZ | 0 | 6 | 1.9 | arketip A3+A4 | `7c4979b5087b5847` |
