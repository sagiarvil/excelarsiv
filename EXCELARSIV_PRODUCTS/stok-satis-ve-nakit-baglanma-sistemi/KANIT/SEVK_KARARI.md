...
- Arketip: **A3** · SPEC: `/Users/macair1/Desktop/excelarsiv-automation/urunler/stok-satis-ve-nakit-baglanma-sistemi/SPEC.yaml` (TAM)
- Tarih: 2026-08-12 13:47 · Orkestratör: kapilar.py v2.0.0 (EXCELARSİV Üretim Mandası v6.0)
...
|---|---|---|---|---|---|---|---|
| G | İşçilik | TEMİZ | 0 | 25 | 1.2 | her ürün | `196c027ccde477a0` |
| Ö | Dayanıklılık | TEMİZ | 0 | 1 | 49.9 | her ürün | `690aa76dda858f47` |
| D | Değer | TEMİZ | 0 | 12 | 8.1 | her ürün | `ed3f6da66984ed56` |
| M | Mevzuat | ATLANDI | 0 | 0 | 0.0 | arketip gerektirmiyor | `—` |
| E | Eşleştirme | ATLANDI | 0 | 0 | 0.0 | arketip gerektirmiyor | `—` |
| A | İş Akışı | TEMİZ | 0 | 6 | 0.7 | arketip A3 | `7c4979b5087b5847` |
