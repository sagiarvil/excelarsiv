#!/usr/bin/env python3
"""
Teşvikli Bordro ve En Avantajlı Teşvik Seçen — üretim betiği (A1 / manda v6).
Ayırt edici: çalışan satır bazlı BORDRO; kişi başı en avantajlı teşvik kodu.
"""
...
URUN_AD = "Teşvikli Bordro ve En Avantajlı Teşvik Seçen"
SURUM = "1.0.0"
RENK = "0F2742"
...
def girdi(ws):
    ...
    h(ws, 18, 2, "=IFERROR(tba_potansiyelTasarruf,0)", sayi=TL, yazi=DIS_REF_YEŞIL, kalin=True)
    h(ws, 19, 1, "Giriş doluluk (kalite)", kalin=True, yazi=KOYU_LACIVERT)
    h(ws, 19, 2,
      '=IFERROR(IF(OR(COUNTA(B6:B16)=0,tba_girisBeklenen=0),0,ROUND(COUNTA(B6:B16)/tba_girisBeklenen*100,0)),0)',
...
def bordro(ws):
    ...
    formuller = {
        "EnAvantajliTutar": (
            ...
            'MAX('
            'IF(tblBordro[[#This Row],[BesPuanUygun]]="Evet",ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranBesPuan,2),0),'
            'IF(tblBordro[[#This Row],[IlaveUygun]]="Evet",ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranIlave,2),0),'
            'IF(tblBordro[[#This Row],[KadinGencUygun]]="Evet",ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranKadinGenc,2),0),'
            'IF(tblBordro[[#This Row],[EngelliUygun]]="Evet",ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_isverenOran,2),0)))'
        ),
        "EnAvantajliKod": (
            '=IF(tblBordro[[#This Row],[CalisanNo]]="","",'
            'IF(tblBordro[[#This Row],[EnAvantajliTutar]]=0,"YOK",'
            'IF(AND(tblBordro[[#This Row],[IlaveUygun]]="Evet",'
            'ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranIlave,2)=tblBordro[[#This Row],[EnAvantajliTutar]]),"TBA-002",'
            'IF(AND(tblBordro[[#This Row],[BesPuanUygun]]="Evet",'
            'ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranBesPuan,2)=tblBordro[[#This Row],[EnAvantajliTutar]]),"TBA-001",'
            'IF(AND(tblBordro[[#This Row],[KadinGencUygun]]="Evet",'
            'ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranKadinGenc,2)=tblBordro[[#This Row],[EnAvantajliTutar]]),"TBA-004","TBA-ENG")))))'
        ),
        "MevcutTutar": (
            '=IF(tblBordro[[#This Row],[CalisanNo]]="","",'
            'IF(tblBordro[[#This Row],[MevcutKod]]="TBA-001",'
            'IF(tblBordro[[#This Row],[BesPuanUygun]]="Evet",ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranBesPuan,2),0),'
            'IF(tblBordro[[#This Row],[MevcutKod]]="TBA-002",'
            'IF(tblBordro[[#This Row],[IlaveUygun]]="Evet",ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranIlave,2),0),'
            'IF(tblBordro[[#This Row],[MevcutKod]]="TBA-004",'
            'IF(tblBordro[[#This Row],[KadinGencUygun]]="Evet",ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_oranKadinGenc,2),0),'
            'IF(tblBordro[[#This Row],[MevcutKod]]="TBA-ENG",'
            'IF(tblBordro[[#This Row],[EngelliUygun]]="Evet",ROUND(tblBordro[[#This Row],[BrutMatrah]]*tba_isverenOran,2),0),0)))))'
        ),
        "Kacirilan": (
            '=IF(tblBordro[[#This Row],[CalisanNo]]="","",'
    ...
    demo = [
        (1, "Ali Yılmaz", 25000, "Evet", "Hayır", "Hayır", "Hayır", "TBA-001"),
        (2, "Ayşe Demir", 22000, "Evet", "Evet", "Hayır", "Hayır", "TBA-001"),
        (3, "Mehmet Kaya", 28000, "Evet", "Hayır", "Evet", "Hayır", "TBA-004"),
        (4, "Zeynep Arslan", 20000, "Hayır", "Evet", "Hayır", "Hayır", "YOK"),
        (5, "Can Öztürk", 30000, "Evet", "Evet", "Hayır", "Evet", "TBA-001"),
        (6, "Elif Şahin", 18000, "Evet", "Hayır", "Evet", "Hayır", "TBA-001"),
        (7, "Burak Çelik", 35000, "Evet", "Evet", "Hayır", "Hayır", "TBA-002"),
        (8, "Selin Aydın", 24000, "Hayır", "Hayır", "Evet", "Hayır", "YOK"),
        (9, "Emre Koç", 27000, "Evet", "Hayır", "Hayır", "Evet", "TBA-001"),
        (10, "Deniz Yıldız", 21000, "Evet", "Evet", "Evet", "Hayır", "TBA-001"),
    ]
    ...
    h(ws, 9, 19,
      ...
      'IF(COUNTIF(tblBordro[EnAvantajliKod],"TBA-002")>=MAX('
      'COUNTIF(tblBordro[EnAvantajliKod],"TBA-001"),'
      'COUNTIF(tblBordro[EnAvantajliKod],"TBA-002"),'
      'COUNTIF(tblBordro[EnAvantajliKod],"TBA-004")),"TBA-002",'
      'IF(COUNTIF(tblBordro[EnAvantajliKod],"TBA-001")>=COUNTIF(tblBordro[EnAvantajliKod],"TBA-004"),'
      '"TBA-001","TBA-004"))),"-")',
    ...
    for i, (kod, adet) in enumerate([
        ("TBA-001", 4), ("TBA-002", 3), ("TBA-004", 2), ("YOK", 1),
    ], 13):
...
def kurallar(ws):
    ...
    satirlar = [
        ["TBA-001", "5510 md.81", "bes_puan_oran", "kapsam_matrah>0", "bes_puan_oran",
         0.05, 0.05, 0.05, "01.01.2025", "5510 s.K. md.81"],
        ["TBA-002", "4447 geç.10", "ilave_istihdam_oran", "ilave_matrah>0", "ilave_istihdam_oran",
         0.145, 0.145, 0.145, "01.01.2025", "4447 s.K. geç.10"],
        ["TBA-003", "SGK tavan", "prim_tavani", "her hesap", "prim_tavani",
         150000, 165000, 180000, "01.01.2025", "SGK prim tavanı"],
        ["TBA-004", "4447 / 5510", "kadin_genc_oran", "kadin_genc_matrah>0", "kadin_genc_oran",
         0.05, 0.05, 0.05, "01.01.2025", "Kadın/genç istihdam"],
        ["TBA-005", "Genel", "yuvarlama", "her hesap", "yuvarlama_ondalik",
    ...
    for i, s in enumerate(satirlar, 7):
        for k, v in enumerate(s, 1):
            ...
            if k in (6, 7, 8) and s[0] in ("TBA-003", "TBA-005"):
                sayi = CATI if s[0] == "TBA-005" else TL
    ...
    formuller = {
        "aktif_deger": (
            ...
            "IFERROR(CHOOSE(MAX(1,MIN(3,IF(OR(hesapYili=\"\",hesapYili=0),1,hesapYili-tba_yilTaban))),"
    ...
    h(ws, 15, 2, kural_cek("TBA-001"), sayi=YÜZDE, yazi=DIS_REF_YEŞIL)
    h(ws, 16, 1, "İlave istihdam oranı (aktif yıl)", yazi="333333")
    h(ws, 16, 2, kural_cek("TBA-002"), sayi=YÜZDE, yazi=DIS_REF_YEŞIL)
    h(ws, 17, 1, "Matris metni", yazi="333333")
    h(ws, 17, 2,
      '=IFERROR(_xlfn.TEXTJOIN(" | ",TRUE,"TBA-001=",TEXT(B15,"0.0%"),"TBA-002=",TEXT(B16,"0.0%"),'
...
def motor(ws):
    ...
    ekle("Hesap yılı oku", "=hesapYili", "yıl", "Aktif mevzuat yılı", "TBA-005")  # G7
    ekle("5 puan oranı", km("TBA-001"), "oran", "5510 md.81 oranı", "TBA-001")  # G8
    ekle("İlave istihdam oranı", km("TBA-002"), "oran", "4447 geç.10 oranı", "TBA-002")  # G9
    ekle("Prim tavanı", km("TBA-003"), "TL", "Aylık prim tavanı", "TBA-003")  # G10
    ekle("Kadın/genç oranı", km("TBA-004"), "oran", "Kadın/genç teşvik oranı", "TBA-004")  # G11
    ekle("Yuvarlama ondalık", km("TBA-005"), "adet", "Yuvarlama basamağı", "TBA-005")  # G12
    ekle("Aylık brüt matrah", '=IF(COUNTA(tblBordro[CalisanNo])>0,SUM(tblBordro[BrutMatrah]),GIRDI!B9)', "TL", "Ham brüt matrah", "TBA-003")  # G13
    ekle("Çalışan sayısı", '=IF(COUNTA(tblBordro[CalisanNo])>0,COUNTA(tblBordro[CalisanNo]),GIRDI!B10)', "adet", "Bildirilen çalışan", "TBA-003")  # G14
    ekle("5 puan kapsam", '=IF(COUNTA(tblBordro[CalisanNo])>0,SUMIF(tblBordro[BesPuanUygun],"Evet",tblBordro[BrutMatrah]),GIRDI!B11)', "TL", "5 puan uygun matrah", "TBA-001")  # G15
    ekle("İlave kapsam", '=IF(COUNTA(tblBordro[CalisanNo])>0,SUMIF(tblBordro[IlaveUygun],"Evet",tblBordro[BrutMatrah]),GIRDI!B12)', "TL", "İlave uygun matrah", "TBA-002")  # G16
    ekle("Kadın/genç kapsam", '=IF(COUNTA(tblBordro[CalisanNo])>0,SUMIF(tblBordro[KadinGencUygun],"Evet",tblBordro[BrutMatrah]),GIRDI!B13)', "TL", "Kadın/genç matrah", "TBA-004")  # G17
    ekle("Engelli kapsam", '=IF(COUNTA(tblBordro[CalisanNo])>0,SUMIF(tblBordro[EngelliUygun],"Evet",tblBordro[BrutMatrah]),GIRDI!B14)', "TL", "Engelli matrah", "TBA-002")  # G18
    ekle("Mevcut teşvik", '=IF(COUNTA(tblBordro[CalisanNo])>0,SUM(tblBordro[MevcutTutar]),GIRDI!B15)', "TL", "Fiili uygulanan", "TBA-005")  # G19
    ekle("Tavan üst sınırı", "=G10*G14", "TL", "Tavan × çalışan", "TBA-003")  # G20
    ekle("Matrah tavanlı", "=MIN(G13,G20)", "TL", "Tavan kesilmiş matrah", "TBA-003")  # G21
    ekle("5 puan (kesilmiş)", f"=ROUND(MIN(G15,G21)*G8,{_YV})", "TL", "5 puan tasarrufu", "TBA-001")  # G22
    ekle("İlave (kesilmiş)", f"=ROUND(MIN(G16,G21)*G9,{_YV})", "TL", "İlave tasarrufu", "TBA-002")  # G23
    ekle("Kadın/genç (kesilmiş)", f"=ROUND(MIN(G17,G21)*G11,{_YV})", "TL", "Kadın/genç tasarrufu", "TBA-004")  # G24
    ekle("Engelli (işveren payı)", f"=ROUND(MIN(G18,G21)*tba_isverenOran,{_YV})", "TL",
         "Engelli işveren payı muafiyeti", "TBA-002")  # G25
    ekle("Birikimli toplam (A)", "=G22+G23+G24+G25", "TL", "Yorum A birikim", "TBA-005")  # G26
    ekle("En yüksek tek kalem (B)", "=MAX(G22,G23,G24,G25)", "TL", "Yorum B tek seçim", "TBA-005")  # G27
    ekle("Potansiyel tasarruf",
         '=IF(GIRDI!B16="B",G27,G26)',
         "TL", "Seçili yoruma göre", "TBA-005")  # G28
    ekle("Kaçırılan (ham)", "=G28-G19", "TL", "Potansiyel − mevcut", "TBA-005")  # G29
    ekle("Kaçırılan (sıfır altı yok)", "=MAX(0,G29)", "TL", "Optimizasyon fırsatı", "TBA-005")  # G30
    ekle("Yıllık potansiyel", "=G28*12", "TL", "12 ay projeksiyon", "TBA-005")  # G31
    ekle("Yıllık kaçırılan", "=G30*12", "TL", "12 ay kaçırılan", "TBA-005")  # G32
    ekle("Karar kodu",
         '=IF(COUNTA(tblBordro[CalisanNo])=0,"VERI_YOK",'
         'IF(OR(MIN(tblBordro[BrutMatrah])<0,MAX(tblBordro[BrutMatrah])>tba_azamiMatrahEsik),"UC",'
         'IF(G30=0,"TAM","FIRSAT")))',
         "kod", "Karar kodu", "TBA-005")  # G33
    ekle("Karar metni",
         '=IF(G33="VERI_YOK","VERİ YOK",'
         'IF(G33="UC","İNCELE",'
         'IF(G33="TAM","UYGUN",'
         'IF(G30>=tba_kacirilanEsik,"UYGULA","İNCELE"))))',
         "metin", "Kullanıcıya karar", "TBA-005")  # G34
    ekle("Gerekçe",
         ...
         "metin", "Gerekçe cümlesi", "TBA-005")  # G35
    ekle("Kapsam / matrah oranı", "=IF(G21=0,0,(G15+G16+G17+G18)/G21)", "oran",
         "Kapsam yoğunluğu", "TBA-003")  # G36
    ekle("Mevcut / potansiyel", "=IF(G28=0,0,G19/G28)", "oran", "Karşılama oranı", "TBA-005")  # G37
    ekle("Güven skoru",
         "=IFERROR(ROUND(IF(OR(COUNTA(GIRDI!B6:B16)=0,tba_girisBeklenen=0),0,"
         "COUNTA(GIRDI!B6:B16)/tba_girisBeklenen*100),0),0)",
         "puan", "Giriş bütünlüğü", "TBA-005")  # G38
    ekle("Risk skoru",
         '=IF(G33="VERI_YOK",0,IF(G30=0,tba_riskDusuk,'
         'IF(G30/MAX(G28,1)>tba_riskEsikOran,tba_riskYuksek,tba_riskOrta)))',
         "puan", "Kaçırılan riski", "TBA-005")  # G39
    ekle("Senaryo iyimser matrah", "=G21*tba_senaryoIyi", "TL", "İyimser matrah", "TBA-003")  # G40
    ekle("Senaryo kötümser matrah", "=G21*tba_senaryoKotu", "TL", "Kötümser matrah", "TBA-003")  # G41
    ekle("İyimser potansiyel",
         f"=ROUND(MIN(G15,G40)*G8+MIN(G16,G40)*G9+MIN(G17,G40)*G11+MIN(G18,G40)*tba_isverenOran,{_YV})",
         "TL", "İyimser birikim", "TBA-001")  # G42
    ekle("Kötümser potansiyel",
         f"=ROUND(MIN(G15,G41)*G8+MIN(G16,G41)*G9+MIN(G17,G41)*G11+MIN(G18,G41)*tba_isverenOran,{_YV})",
         "TL", "Kötümser birikim", "TBA-001")  # G43
    ekle("Kural+1 puan 5 puan", f"=ROUND(MIN(G15,G21)*(G8+tba_oranArtisPuan),{_YV})", "TL",
         "M-SEN +1 puan", "TBA-001")  # G44
    ekle("M-SEN potansiyel", "=G44+G23+G24+G25", "TL", "Kural değişimi toplam", "TBA-001")  # G45
    ekle("M-SEN kaçırılan", "=MAX(0,G45-G19)", "TL", "M-SEN farkı", "TBA-005")  # G46
    ekle("Tahmin üst", "=G30*tba_tahminUst", "TL", "Tahmin üst bant", "TBA-005")  # G47
    ekle("Tahmin alt", "=G30*tba_tahminAlt", "TL", "Tahmin alt bant", "TBA-005")  # G48
    ekle("Tornado: matrah etkisi",
         f"=ABS(ROUND(MIN(G15,G21*tba_tornadoMatrah)*G8+MIN(G16,G21*tba_tornadoMatrah)*G9"
         f"+MIN(G17,G21*tba_tornadoMatrah)*G11+MIN(G18,G21*tba_tornadoMatrah)*tba_isverenOran,{_YV})-G28)",
         "TL", "Matrah ± etki", "TBA-003")  # G49
    ekle("Tornado: mevcut etkisi",
         "=ABS(MAX(0,G28-G19*tba_tornadoMevcut)-G30)",
         "TL", "Mevcut ± etki", "TBA-005")  # G50
    ekle("Tornado: oran etkisi",
         f"=ABS(ROUND(MIN(G15,G21)*(G8+tba_oranArtisPuan)+G23+G24+G25,{_YV})-G28)",
         "TL", "Oran ± etki", "TBA-001")  # G51
    ekle("Madde atıf özeti",
         '=_xlfn.TEXTJOIN(" | ",TRUE,"TBA-001→5510 md.81","TBA-002→4447 geç.10","TBA-003→prim tavanı")',
         "metin", "Kanıt atıfları", "TBA-001")  # G52
    ekle("Kanıt satır özeti",
         '=_xlfn.TEXTJOIN(" · ",TRUE,"Matrah=",TEXT(G21,"₺ #,##0"),"Potansiyel=",TEXT(G28,"₺ #,##0"),'
         '"Kaçırılan=",TEXT(G30,"₺ #,##0"))',
         "metin", "Rapor özeti", "TBA-005")  # G53
...
def senaryo(ws):
    ...
    pot = "IFERROR(tba_potansiyelTasarruf,0)"
    mev = "IFERROR(tba_mevcutTesvik,0)"
    senaryolar = [
        ("İyimser", "=IFERROR(tba_senaryoIyi+N(GIRDI!B9)*0,0)",
         f"=IFERROR(ROUND(({pot})*B6,2),0)",
         f"=IFERROR(MAX(0,C6-({mev})),0)",
         '=IF(COUNTA(tblBordro[CalisanNo])=0,"VERİ YOK",IF(D6=0,"UYGUN",IF(D6>=tba_kacirilanEsik,"UYGULA","İNCELE")))'),
        ("Baz", "=IFERROR(1+N(GIRDI!B9)*0,1)",
         f"=IFERROR(ROUND(({pot})*B7,2),0)",
         f"=IFERROR(MAX(0,C7-({mev})),0)",
         '=IF(COUNTA(tblBordro[CalisanNo])=0,"VERİ YOK",IF(D7=0,"UYGUN",IF(D7>=tba_kacirilanEsik,"UYGULA","İNCELE")))'),
        ("Kötümser", "=IFERROR(tba_senaryoKotu+N(GIRDI!B9)*0,0)",
         f"=IFERROR(ROUND(({pot})*B8,2),0)",
         f"=IFERROR(MAX(0,C8-({mev})),0)",
         '=IF(COUNTA(tblBordro[CalisanNo])=0,"VERİ YOK",IF(D8=0,"UYGUN",IF(D8>=tba_kacirilanEsik,"UYGULA","İNCELE")))'),
        ("M-SEN +1 puan", "=IFERROR(1+N(GIRDI!B9)*0,1)",
         "=IFERROR(MOTOR!G45,0)",
         "=IFERROR(MOTOR!G46,0)",
         '=IF(COUNTA(tblBordro[CalisanNo])=0,"VERİ YOK",IF(D9=0,"UYGUN",IF(D9>=tba_kacirilanEsik,"UYGULA","İNCELE")))'),
    ]
    ...
    h(ws, 25, 3, "=tba_kacirilan", sayi=TL, yazi=DIS_REF_YEŞIL)
...
def vakalar(ws):
    ...
    vakalar_data = [
        ("V-001", "Tebliğ örnek 1 — 5 puan",
         ...
         15000,
         "=IFERROR(ROUND(vaka_matrah_1*INDEX(tblKurallar[deger_2025],MATCH(\"TBA-001\",tblKurallar[kural_id],0)),2),0)",
         "=IFERROR(D6-E6,0)",
         '=IFERROR(IF(ABS(F6)<=tba_tolerans,"TUTARLI","KIRIK"),"KIRIK")',
         "5510 md.81 örnek"),
        ("V-002", "Tebliğ örnek 2 — ilave istihdam",
         "ilave_matrah=vaka_matrah_2",
         14500,
         "=IFERROR(ROUND(vaka_matrah_2*INDEX(tblKurallar[deger_2025],MATCH(\"TBA-002\",tblKurallar[kural_id],0)),2),0)",
         "=IFERROR(D7-E7,0)",
         '=IFERROR(IF(ABS(F7)<=tba_tolerans,"TUTARLI","KIRIK"),"KIRIK")',
         "4447 geç.10 örnek"),
        ("V-003", "Tebliğ örnek 3 — birikimli A",
         "5 puan + ilave",
         29500,
         "=IFERROR(ROUND(vaka_matrah_1*INDEX(tblKurallar[deger_2025],MATCH(\"TBA-001\",tblKurallar[kural_id],0))"
         "+vaka_matrah_2*INDEX(tblKurallar[deger_2025],MATCH(\"TBA-002\",tblKurallar[kural_id],0)),2),0)",
         "=IFERROR(D8-E8,0)",
         '=IFERROR(IF(ABS(F8)<=tba_tolerans,"TUTARLI","KIRIK"),"KIRIK")',
         "Birikim yorum A"),
        ("V-004", "Tavan × 5 puan kontrol",
         "tavan=vaka_tavan; oran TBA-001",
         7500,
         "=IFERROR(ROUND(vaka_tavan*INDEX(tblKurallar[deger_2025],MATCH(\"TBA-001\",tblKurallar[kural_id],0)),2),0)",
         "=IFERROR(D9-E9,0)",
         '=IFERROR(IF(ABS(F9)<=tba_tolerans,"TUTARLI","KIRIK"),"KIRIK")',
         "TBA-003 tavan kontrol"),
    ]
    ...
    formuller = {
        ...
        "durum": '=IF(tblVakalar[[#This Row],[vaka_id]]="","",IFERROR(IF(ABS(tblVakalar[[#This Row],[fark]])<=tba_tolerans,"TUTARLI","KIRIK"),"KIRIK"))',
    }
...
def kanit_raporu(ws):
    ...
    h(ws, 3, 1, "KANIT RAPORU — Teşvikli Bordro", kalin=True, boyut=14, yazi=KOYU_LACIVERT, kaydir=True)
    ...
    for i, (et, form, sayi) in enumerate([
        ...
        ("Mevcut teşvik", "=tba_mevcutTesvik", TL),
    ], 9):
    ...
    h(ws, 18, 2, "=tba_potansiyelTasarruf", sayi=TL, yazi=DIS_REF_YEŞIL, kalin=True)
    h(ws, 19, 1, "Kaçırılan", yazi="333333")
    h(ws, 19, 2, "=tba_kacirilan", sayi=TL, yazi=DIS_REF_YEŞIL, kalin=True)
    h(ws, 20, 1, "KARAR", kalin=True, yazi=KOYU_LACIVERT)
    h(ws, 20, 2, "=tba_kararMetni", kalin=True, boyut=12, yazi=DIS_REF_YEŞIL)
    h(ws, 21, 1, "Gerekçe", yazi="333333")
    h(ws, 21, 2, "=tba_kararGerekce", yazi=DIS_REF_YEŞIL, kaydir=True)
    ws.merge_cells("B21:F21")

    h(ws, 23, 1, "Madde atıfları", kalin=True, yazi=KOYU_LACIVERT)
    h(ws, 23, 2, "=tba_maddeAtifMetni", yazi=DIS_REF_YEŞIL, kaydir=True)
    ws.merge_cells("B23:F23")

    h(ws, 25, 1, "Kanıt gövdesi", kalin=True, yazi=KOYU_LACIVERT)
    h(ws, 25, 2, "=tba_kanitRaporu", yazi=DIS_REF_YEŞIL, kaydir=True)
    ws.merge_cells("B25:F25")

    h(ws, 27, 1, "Parmak izi (SHA-256 kısaltma)", yazi="333333")
    h(ws, 27, 2, "=tba_parmakIzi", yazi=GRİ)
...
def pano(ws):
    ...
    h(ws, 3, 1, "Yönetim paneli — Teşvikli Bordro", kalin=True, boyut=14, yazi=KOYU_LACIVERT)

    kpiler = [
        (2, "Matrah", "=IFERROR(MOTOR!G21,0)", TL),
        (3, "Potansiyel", "=IFERROR(tba_potansiyelTasarruf,0)", TL),
        (4, "Mevcut", "=IFERROR(tba_mevcutTesvik,0)", TL),
        (5, "Kaçırılan", "=IFERROR(tba_kacirilan,0)", TL),
        ...
        (11, "M-SEN", "=IFERROR(tba_kuralDegisimSenaryo,0)", TL),
        (12, "Tahmin", "=IFERROR(SENARYO!B32,0)", TL),
        (13, "Vaka", "=IFERROR(tba_vakaDurum,\"-\")", None),
    ]
    ...
    h(ws, 6, 2, "=tba_kararMetni", boyut=14, kalin=True, yazi=DIS_REF_YEŞIL)
    h(ws, 7, 1, "Gerekçe", kalin=True, yazi=KOYU_LACIVERT)
    h(ws, 7, 2, "=tba_kararGerekce", yazi=DIS_REF_YEŞIL, kaydir=True)
    ...
    moduller = [
        ...
        ("O2", "Tornado max etki",
         "=IFERROR(tba_duyarlilikSira,\"-\")",
         "=IFERROR(tba_yorumDuyarlilik,\"-\")"),
        ("O3", "Senaryo bant",
         "=IFERROR(tba_senaryoKarsilastirma,0)",
         "=IFERROR(tba_yorumSenaryo,\"-\")"),
        ("O6", "5 puan payı",
         "=IFERROR(IF(tba_potansiyelTasarruf=0,0,MOTOR!G22/tba_potansiyelTasarruf),0)",
         '=_xlfn.TEXTJOIN("; ",TRUE,"5 puan / potansiyel ",TEXT(C16,"0.0%"))'),
        ("O8", "Kalite skoru",
         "=IFERROR(KONTROLLER!B12,0)",
         '=_xlfn.TEXTJOIN("; ",TRUE,"Kalite ",TEXT(C17,"0")," puan")'),
        ("M", "M-SEN kaçırılan",
         "=IFERROR(tba_kuralDegisimSenaryo,0)",
         "=IFERROR(tba_yorumKuralDegisim,\"-\")"),
        ("I1", "Tahmin aralık",
         "=IFERROR(tba_tahminAralik,0)",
         "=IFERROR(tba_yorumTahmin,\"-\")"),
        ("I2", "Senaryo kaçırılan P90",
         "=IFERROR(IF(COUNT(SENARYO!D6:D9)<2,0,_xlfn.PERCENTILE.INC(SENARYO!D6:D9,tba_yuzdelikOran)),0)",
...
def kontroller(ws):
    ...
    kontroller_list = [
        ...
        ("Hesap yılı geçerli mi?",
         '=IFERROR(IF(AND(N(hesapYili)>N(tba_yilTaban),N(hesapYili)<=N(tba_yilTaban)+3),"TEMİZ","HATALI"),"HATALI")'),
        ("Matrah sıfır mı?",
         '=IF(IFERROR(MOTOR!G21,0)=0,"SIFIR","NORMAL")'),
        ("Vaka kırık mı?",
         '=IFERROR(IF(COUNTIF(tblVakalar[durum],"KIRIK")>0,"KIRIK","TUTARLI"),"KIRIK")'),
        ("Kaçırılan eşiği aşıyor mu?",
         '=IF(IFERROR(tba_kacirilan,0)>tba_kacirilanEsik,"AŞIYOR","NORMAL")'),
        ("Yorum A/B seçili mi?",
    ...
    h(ws, 14, 2, "=IFERROR(tba_girisBeklenen+COUNTA(GIRDI!B6:B16)*0,0)", sayi=CATI, yazi=DIS_REF_YEŞIL)
    ...
    h(ws, 17, 2, "=IFERROR(tba_potansiyelTasarruf,0)", sayi=TL, yazi=DIS_REF_YEŞIL)
    h(ws, 18, 1, "Kaçırılan kontrol", yazi="333333")
    h(ws, 18, 2, "=IFERROR(tba_kacirilan,0)", sayi=TL, yazi=DIS_REF_YEŞIL)
    h(ws, 19, 1, "Karar kontrol", yazi="333333")
    h(ws, 19, 2, "=IFERROR(tba_kararMetni,\"-\")", yazi=DIS_REF_YEŞIL)
...
def ornek_veri(ws):
    ...
    formuller = {
        "Potansiyel": (
            ...
            "MATCH(\"TBA-001\",tblKurallar[kural_id],0))"
            "+tblOrnek[[#This Row],[İlave]]*INDEX(tblKurallar[deger_2025],"
            "MATCH(\"TBA-002\",tblKurallar[kural_id],0))"
            "+tblOrnek[[#This Row],[Kadın/Genç]]*INDEX(tblKurallar[deger_2025],"
            "MATCH(\"TBA-004\",tblKurallar[kural_id],0))"
            "+tblOrnek[[#This Row],[Engelli]]*tba_isverenOran,2),0))"
        ),
        "Kaçırılan": (
            "=IF(tblOrnek[[#This Row],[Senaryo]]=\"\",\"\","
...
def listeler(ws):
    ...
    for i, v in enumerate(["TBA-001", "TBA-002", "TBA-004", "TBA-ENG", "YOK"], 6):
...
def ayarlar(ws):
    ...
    params = [
        ...
        ("tba_tolerans", 0.01, "TL", "Vaka tutarlılık toleransı", "Uygulama notu", "01.01.2025", "11.08.2026"),
        ("tba_kacirilanEsik", 15_000, "TL", "PANO kaçırılan uyarı eşiği", "İç politika", "01.01.2025", "11.08.2026"),
        ("tba_senaryoIyi", 0.90, "çarpan", "İyimser matrah çarpanı", "Model varsayımı", "01.01.2025", "11.08.2026"),
        ("tba_senaryoKotu", 1.10, "çarpan", "Kötümser matrah çarpanı", "Model varsayımı", "01.01.2025", "11.08.2026"),
        ("tba_oranArtisPuan", 0.01, "oran", "M-SEN +1 puan", "Senaryo motoru", "01.01.2025", "11.08.2026"),
        ("tba_tahminAlt", 0.85, "çarpan", "Tahmin alt bant", "Model varsayımı", "01.01.2025", "11.08.2026"),
        ("tba_tahminUst", 1.15, "çarpan", "Tahmin üst bant", "Model varsayımı", "01.01.2025", "11.08.2026"),
        ("tba_tornadoMatrah", 1.05, "çarpan", "Tornado matrah şoku", "Model varsayımı", "01.01.2025", "11.08.2026"),
        ("tba_tornadoMevcut", 0.95, "çarpan", "Tornado mevcut şoku", "Model varsayımı", "01.01.2025", "11.08.2026"),
        ("tba_isverenOran", 0.205, "oran", "İşveren SGK payı (engelli)", "5510 s.K.", "01.01.2025", "11.08.2026"),
        ("tba_yuzdelikOran", 0.90, "oran", "Yüzdelik P90", "İstatistik", "01.01.2025", "11.08.2026"),
        ("tba_parmakIzi", "TBA-PRO-1.0.0", "metin", "Dosya parmak izi etiketi", "Üretim", "01.01.2025", "11.08.2026"),
        ("dosya_surumu", SURUM, "metin", "Ürün sürümü", "ExcelArşiv", "01.01.2025", "11.08.2026"),
        ("tba_girisBeklenen", 11, "adet", "Zorunlu giriş alanı sayısı", "Ürün mimarisi", "01.01.2025", "11.08.2026"),
        ("tba_riskDusuk", 15, "puan", "Düşük risk skoru", "İç politika", "01.01.2025", "11.08.2026"),
        ("tba_riskOrta", 55, "puan", "Orta risk skoru", "İç politika", "01.01.2025", "11.08.2026"),
        ("tba_riskYuksek", 85, "puan", "Yüksek risk skoru", "İç politika", "01.01.2025", "11.08.2026"),
        ("tba_riskEsikOran", 0.5, "oran", "Yüksek risk kaçırılan/potansiyel", "İç politika", "01.01.2025", "11.08.2026"),
        ("tba_yilTaban", 2024, "yıl", "CHOOSE yıl tabanı (hesapYili−taban)", "Ürün mimarisi", "01.01.2025", "11.08.2026"),
        ("tba_yuvarMax", 10, "adet", "ROUND basamak tavanı", "Ürün mimarisi", "01.01.2025", "11.08.2026"),
        ("tba_azamiMatrahEsik", 100_000_000, "TL", "Uç matrah eşiği (Ö2)", "İç politika", "01.01.2025", "11.08.2026"),
...
def kilavuz(ws):
    ...
    for i, m in enumerate([
        ...
        "UYGULA — kaçırılan ≥ eşik; kişi başı en avantajlı teşvik kodunu uygulayın.",
    ], 5):
        h(ws, i, 1, "• " + m, yazi="333333", kaydir=True)
    ...
    h(ws, 17, 1,
      "GIRDI → BORDRO (çalışan satırları) → KURALLAR → MOTOR → SENARYO → VAKALAR → PANO → KANIT_RAPORU → AYARLAR.",
      kaydir=True, yazi="333333")
...
def kosullu_bicimlendirme(wb):
    ...
    ws.conditional_formatting.add("F7:F53", FormulaRule(formula=['F7="TBA-001"'], font=Font(color="B08948", bold=True)))
    ws.conditional_formatting.add("F7:F53", FormulaRule(formula=['F7="TBA-005"'], font=Font(color=KRITIK, bold=True)))
...
def ad_tanimlari(wb):
    ...
    ad_ekle(wb, "tba_oranBesPuan", "MOTOR!$G$8")
    ad_ekle(wb, "tba_oranIlave", "MOTOR!$G$9")
    ad_ekle(wb, "tba_oranKadinGenc", "MOTOR!$G$11")
    ad_ekle(wb, "tba_mevcutTesvik", "MOTOR!$G$19")
    ad_ekle(wb, "tba_potansiyelTasarruf", "MOTOR!$G$28")
    ad_ekle(wb, "tba_kacirilan", "MOTOR!$G$30")
    ad_ekle(wb, "tba_kararMetni", "MOTOR!$G$34")
    ad_ekle(wb, "tba_kararGerekce", "MOTOR!$G$35")
    ad_ekle(wb, "tba_maddeAtifMetni", "MOTOR!$G$52")
    ad_ekle(wb, "tba_kanitRaporu", "MOTOR!$G$53")
    ad_ekle(wb, "tba_kuralYilMatris", "KURALLAR!$B$17")
    ad_ekle(wb, "tba_parmakIzi", "AYARLAR!$B$19")

    ad_ekle(wb, "tba_senaryoKarsilastirma", "SENARYO!$B$11")
    ad_ekle(wb, "tba_yorumSenaryo", "SENARYO!$B$12")
    ad_ekle(wb, "tba_duyarlilikSira", "SENARYO!$B$19")
    ad_ekle(wb, "tba_yorumDuyarlilik", "SENARYO!$B$20")
    ad_ekle(wb, "tba_kuralDegisimSenaryo", "SENARYO!$B$22")
    ad_ekle(wb, "tba_yorumKuralDegisim", "SENARYO!$B$23")
    ad_ekle(wb, "tba_tahminAralik", "SENARYO!$B$32")
    ad_ekle(wb, "tba_yorumTahmin", "SENARYO!$B$33")

    ad_ekle(wb, "tba_vakaDurum", "VAKALAR!$B$12")
    ad_ekle(wb, "tba_vakaFark", "VAKALAR!$B$13")
    ...
    ayar_map = {
        ...
        "tba_senaryoIyi": 10,
        "tba_senaryoKotu": 11,
        "tba_oranArtisPuan": 12,
        "tba_tahminAlt": 13,
        "tba_tahminUst": 14,
        "tba_tornadoMatrah": 15,
        "tba_tornadoMevcut": 16,
        "tba_isverenOran": 17,
        "tba_yuzdelikOran": 18,
        "tba_girisBeklenen": 21,
        "tba_riskDusuk": 22,
        "tba_riskOrta": 23,
        "tba_riskYuksek": 24,
        "tba_riskEsikOran": 25,
    ...
    modul_map = {
        "tba_modulT1": (11, "C"), "tba_modulT1Yorum": (11, "D"),
        "tba_modulT2": (12, "C"), "tba_modulT2Yorum": (12, "D"),
        "tba_modulO1": (13, "C"), "tba_modulO1Yorum": (13, "D"),
        "tba_modulO6": (16, "C"), "tba_modulO6Yorum": (16, "D"),
        "tba_modulO8": (17, "C"), "tba_modulO8Yorum": (17, "D"),
        "tba_modulI2": (20, "C"), "tba_modulI2Yorum": (20, "D"),
    }
    ...
    ad_ekle(wb, "tba_bordroSatir", "BORDRO!$A$6")
    ad_ekle(wb, "tba_enAvantajli", "BORDRO!$S$9")
    ad_ekle(wb, "tba_kararKapi", "MOTOR!$G$34")
...
def main(cikti_yolu=None):
    ...
    varsayilan = os.path.join(kok, "TesvikliBordroAvantajliTesvik.xlsx")
...
if __name__ == "__main__":
    ...
    cikti = os.path.join(repo, "cikti", "TesvikliBordroAvantajliTesvik.xlsx")
