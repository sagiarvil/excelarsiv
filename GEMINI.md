# 🎛️ GEMINI MASTER SUITE & PROJE YÖNETİCİSİ ANAYASASI — EXCEL-ARSIV
...
5. **Tasarım Sözleşmesi Şartı:** Read `DESIGN.md` completely. `DESIGN.md` is the canonical visual contract. Zorunlu testler: `npm run guard:design`, `npm run build`, `npm test`.
