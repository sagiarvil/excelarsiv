...
/* Enterprise light contract. The full presentation layer lives in the isolated public stylesheet. */
body.special-light-v1{--max:1180px;font-family:"Manrope",ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;color-scheme:light!important}.special-light-v1 .wrap{width:min(1180px,calc(100% - 48px))!important}.special-light-v1 .solution-grid{grid-template-columns:repeat(12,1fr)!important}.special-light-v1 .native-info--special{background:linear-gradient(180deg,#fff,#f8fbfe)!important;color:#10233f!important;border-color:#dbe5ef!important}.special-light-v1 .native-info--special h2{color:#10233f!important}.special-light-v1 .native-info--special .native-info__eyebrow{color:#107c41!important}.special-light-v1 .native-info--special .native-info__lead,.special-light-v1 .native-info--special .native-info__card span,.special-light-v1 .native-info--special .native-info__outcomes span,.special-light-v1 .native-info--special .native-info__footer p{color:#66778e!important}.special-light-v1 .native-info--special .native-info__card,.special-light-v1 .native-info--special .native-info__outcomes article{background:#fff!important;border-color:#dce5ee!important}.special-light-v1 .native-info--special .native-info__card strong,.special-light-v1 .native-info--special .native-info__outcomes strong{color:#10233f!important}.special-light-v1 .native-info--special .native-info__cta{background:#107c41!important;color:#fff!important}.special-light-v1 .native-info--special .native-info__cta:hover{background:#0c6536!important}
...
if (!fs.existsSync(SPECIAL_ENTERPRISE_CSS)) {
  throw new Error('FINAL UI GATE: özel Excel enterprise stylesheet dist içinde bulunamadı');
}
...
if (special.includes('data-special-light-v1') && (!special.includes('--max:1180px') || !special.includes('font-family:"Manrope"') || !special.includes('solution-grid{grid-template-columns:repeat(12,1fr)!important'))) throw new Error('FINAL UI GATE: enterprise light contract missing');
...
console.log(`FINAL UI CONTRAST/LAYOUT GATE PASS — ${changed} sayfa düzeltildi; special=enterprise-exclusive-light`);
