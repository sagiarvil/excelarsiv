...
<section class="finance-pillars" id="finans-sistemleri" data-experience-stage>
  <div class="home-shell">
    <div class="finance-pillars__head">
      <div>
        <p class="eyebrow">TÜM FİNANSAL İHTİYAÇLARINIZ TEK ÇATIDA</p>
...
.finance-needs-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-bottom:34px}
