...
const headerMarkup = `<header class="site-nav">
    <div class="wrap-wide nav-inner">
      <a class="brand" href="/" aria-label="Excel Arşiv ana sayfa">
        <img src="/images/excel-logo.png" alt="Excel Arşiv Logo" width="38" height="38" />
        <span class="brand-copy">
          <strong>EXCELARŞİV</strong>
          <small>ÖZEL EXCEL SİSTEMLERİ</small>
        </span>
      </a>
      <nav class="nav-links" aria-label="Ana menü">
        <a href="#ihtiyaclar">İhtiyaçlar</a>
        <a href="#karsilastirma">Farkımız</a>
        <a href="#mimariler">Sistemler</a>
...
const livingWorkbookCss = fs.readFileSync(path.resolve('src/styles/living-workbook-v1.css'), 'utf8');
const finalContract = `
