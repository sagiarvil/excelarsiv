...
requireReplace(/<a class="btn btn-primary[^"]*" href="\/iletisim">İhtiyacımı anlatmak istiyorum <span aria-hidden="true">→<\/span><\/a>/u, `<a class="btn btn-primary btn-whatsapp btn-magnetic" href="${links.hero}" target="_blank" rel="noopener noreferrer" data-event="cta_whatsapp_click" data-cta="hero_whatsapp" data-location="top">İhtiyacımı Anlat <span aria-hidden="true">→</span></a>`, 'hero WhatsApp CTA');
...
body[data-special-premium-v17]{--premium-navy:#222222;--premium-green:#107c41;--premium-shadow:0 14px 40px rgba(0,0,0,.06)}
body[data-special-premium-v17] .hero{padding:42px 0 36px!important;background:linear-gradient(135deg,#ffffff 0%,#f8faf9 60%,#eff7f2 100%)!important;overflow:hidden}
body[data-special-premium-v17] .hero>.wrap-wide{width:min(1140px,calc(100% - 48px))!important}
body[data-special-premium-v17] .hero-grid{grid-template-columns:minmax(0,1.2fr) minmax(0,.8fr)!important;gap:28px!important;align-items:center!important}
body[data-special-premium-v17] .hero-copy{padding-block:4px!important}
body[data-special-premium-v17] .hero h1{max-width:620px!important;margin:0!important;font-size:clamp(34px,3.8vw,44px)!important;line-height:1.16!important;font-weight:800!important;letter-spacing:-.03em!important;color:#222222!important;text-wrap:balance}
body[data-special-premium-v17] .hero-lead{max-width:580px!important;margin-top:14px!important;font-size:16.5px!important;line-height:1.6!important;color:#444444!important;letter-spacing:-.01em!important}
body[data-special-premium-v17] .hero-actions{margin-top:20px!important;gap:12px!important}
body[data-special-premium-v17] .hero-actions .btn{min-height:48px!important;padding:0 22px!important;border-radius:10px!important;font-size:15px!important;font-weight:700!important}
body[data-special-premium-v17] .hero-bullets{margin-top:16px!important;gap:10px 16px!important}
body[data-special-premium-v17] .hero-bullets li{font-size:14px!important;color:#444444!important;line-height:1.45!important}
body[data-special-premium-v17] .hero-copy>.proof-grid{display:none!important}
body[data-special-premium-v17] .workbook{min-width:0!important;max-width:100%!important;border-radius:16px!important;border-color:#cfe0d5!important;box-shadow:0 18px 40px -10px rgba(15,23,42,.1)!important;transform:none!important}
body[data-special-premium-v17] .wb-top{padding:9px 12px!important}.wb-title{font-size:12.5px!important}.wb-note{font-size:11px!important}
body[data-special-premium-v17] .wb-body{padding:10px!important}.metric-grid{gap:6px!important}.metric{padding:8px 9px!important}.metric small{font-size:10.5px!important}.metric strong{font-size:14.5px!important}.metric span{font-size:10.5px!important}.panel h3{font-size:12px!important}
.hero-proof-premium{position:relative;padding:0 0 40px;background:#fff}.hero-proof-premium::before{content:"";position:absolute;left:0;right:0;top:0;height:1px;background:linear-gradient(90deg,transparent,#dfe7e1 15%,#dfe7e1 85%,transparent)}.hero-proof-premium__grid{width:min(1140px,calc(100% - 48px));display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-inline:auto;padding-top:20px}.hero-proof-premium__card{position:relative;min-width:0;display:grid;grid-template-columns:38px minmax(0,1fr);gap:12px;align-items:start;padding:16px 14px;border:1px solid #dde6df;border-radius:14px;background:#fff;box-shadow:0 6px 18px rgba(15,23,42,.04);overflow:hidden}.hero-proof-premium__card::before{content:"";position:absolute;left:0;right:0;top:0;height:3px;background:#107c41}.hero-proof-premium__card.is-blue::before{background:#2563eb}.hero-proof-premium__card.is-amber::before{background:#d97706}.hero-proof-premium__card.is-violet::before{background:#7c3aed}.hero-proof-premium__icon{width:38px;height:38px;display:grid;place-items:center;border-radius:10px;background:#ecfdf5;color:#047857;font-size:16px;font-weight:850}.is-blue .hero-proof-premium__icon{background:#eff6ff;color:#1d4ed8}.is-amber .hero-proof-premium__icon{background:#fffbeb;color:#b45309}.is-violet .hero-proof-premium__icon{background:#f5f3ff;color:#6d28d9}.hero-proof-premium__card strong{display:block;color:#222222;font-size:15.5px;line-height:1.3;font-weight:750;letter-spacing:-.015em}.hero-proof-premium__card span{display:block;margin-top:4px;color:#555555;font-size:13.5px;line-height:1.5}
.authority-rail{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;max-width:1040px;margin:0 auto 24px;padding:16px;border:1px solid #dbe3eb;border-radius:14px;background:#fff;box-shadow:0 6px 18px rgba(15,23,42,.04)}.authority-item{display:flex;align-items:flex-start;gap:8px;min-width:0;padding:4px 6px;color:#444444;font-size:14px;line-height:1.5}.authority-item strong{flex:0 0 auto;white-space:nowrap;color:#222222;font-weight:800;font-size:14.5px}.authority-item span{min-width:0;overflow-wrap:anywhere}.faq-grid{align-items:start!important}.faq-copy,.faq-list{align-self:start!important;min-width:0}.special-mid-cta{padding:0 0 46px;background:#edf9f2}.special-mid-cta__inner{display:flex;align-items:center;justify-content:space-between;gap:24px;padding:20px 24px;border:1px solid #cfe7d8;border-radius:16px;background:#fff;box-shadow:0 8px 24px rgba(15,23,42,.05)}.special-mid-cta__inner>div{display:grid;gap:4px}.special-mid-cta__inner strong{color:#222222;font-size:18px;line-height:1.3}.special-mid-cta__inner span{color:#555555;font-size:14.5px;line-height:1.55}.special-mid-cta__inner>a{flex:0 0 auto;min-height:46px;display:inline-flex;align-items:center;justify-content:center;padding:0 20px;border-radius:10px;background:#107c41;color:#fff;font-size:14.5px;font-weight:750;text-decoration:none;box-shadow:0 8px 18px rgba(16,124,65,.18)}.btn-whatsapp{background:#107c41!important;color:#fff!important;border-color:#107c41!important}.btn-whatsapp:hover{background:#0b5c30!important}.floating-whatsapp{display:none;position:fixed;right:16px;bottom:calc(16px + env(safe-area-inset-bottom));z-index:140;align-items:center;gap:7px;min-height:46px;padding:0 16px;border:1px solid rgba(255,255,255,.5);border-radius:999px;background:#107c41;color:#fff;font-size:13.5px;text-decoration:none;box-shadow:0 12px 28px rgba(16,124,65,.25)}.floating-whatsapp span{font-size:16px}.floating-whatsapp strong{font-weight:750}
...
@media(max-width:900px){body[data-special-premium-v17] .hero{padding-top:34px!important}body[data-special-premium-v17] .hero-grid{grid-template-columns:1fr!important;gap:24px!important}body[data-special-premium-v17] .hero h1{max-width:820px!important;font-size:clamp(30px,6vw,40px)!important}.workbook{max-width:760px!important;margin-inline:auto!important}.authority-rail{grid-template-columns:1fr}.special-mid-cta__inner{align-items:flex-start;flex-direction:column}.special-mid-cta__inner>a{width:100%}}
@media(max-width:660px){body[data-special-premium-v17] .hero{padding:24px 0 24px!important}body[data-special-premium-v17] .hero>.wrap-wide,.hero-proof-premium__grid{width:calc(100% - 28px)!important}body[data-special-premium-v17] .hero h1{font-size:clamp(28px,8.5vw,36px)!important;line-height:1.1!important;color:#222222!important}body[data-special-premium-v17] .hero-lead{font-size:15.5px!important;line-height:1.6!important;color:#444444!important}.hero-actions{display:grid!important}.hero-actions .btn{width:100%!important;min-height:48px!important;font-size:15px!important}.workbook{display:none!important}.hero-proof-premium{padding-bottom:34px}.hero-proof-premium__grid{grid-template-columns:1fr!important;gap:9px!important;padding-top:16px}.hero-proof-premium__card{grid-template-columns:36px minmax(0,1fr);gap:10px;padding:14px 12px}.hero-proof-premium__icon{width:36px;height:36px}.hero-proof-premium__card strong{font-size:15px;color:#222222}.hero-proof-premium__card span{font-size:13px;line-height:1.45;color:#555555}.authority-rail{margin-bottom:18px;padding:12px}.authority-item{display:grid;grid-template-columns:auto minmax(0,1fr);gap:6px}.authority-item strong{font-size:14px;color:#222222}.authority-item span{font-size:13.5px;color:#444444}.special-mid-cta{padding-bottom:32px}.special-mid-cta__inner{padding:16px}.floating-whatsapp{display:inline-flex}.footer{padding-bottom:86px!important}}
</style>`;
