...
body[data-special-premium-v17] .hero{padding:38px 0 34px!important;background:linear-gradient(135deg,#ffffff 0%,#f8faf9 60%,#eff7f2 100%)!important;overflow:hidden}
body[data-special-premium-v17] .hero>.wrap-wide{width:min(1020px,calc(100% - 48px))!important}
body[data-special-premium-v17] .hero-grid{grid-template-columns:minmax(0,1.2fr) minmax(0,.8fr)!important;gap:24px!important;align-items:center!important}
body[data-special-premium-v17] .hero-copy{padding-block:4px!important}
body[data-special-premium-v17] .hero h1{max-width:580px!important;margin:0!important;font-size:clamp(28px,2.8vw,36px)!important;line-height:1.14!important;font-weight:800!important;letter-spacing:-.035em!important;color:#0f172a!important;text-wrap:balance}
body[data-special-premium-v17] .hero-lead{max-width:540px!important;margin-top:12px!important;font-size:14.5px!important;line-height:1.58!important;color:#475569!important;letter-spacing:-.01em!important}
body[data-special-premium-v17] .hero-actions{margin-top:18px!important;gap:10px!important}
...
body[data-special-premium-v17] .hero-bullets{margin-top:14px!important;gap:8px 14px!important}
body[data-special-premium-v17] .hero-bullets li{font-size:12.5px!important;color:#475569!important}
...
.hero-proof-premium{position:relative;padding:0 0 40px;background:#fff}.hero-proof-premium::before{content:"";position:absolute;left:0;right:0;top:0;height:1px;background:linear-gradient(90deg,transparent,#dfe7e1 15%,#dfe7e1 85%,transparent)}.hero-proof-premium__grid{width:min(1020px,calc(100% - 48px));display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-inline:auto;padding-top:20px}.hero-proof-premium__card{position:relative;min-width:0;display:grid;grid-template-columns:38px minmax(0,1fr);gap:12px;align-items:start;padding:16px 14px;border:1px solid #dde6df;border-radius:14px;background:#fff;box-shadow:0 6px 18px rgba(15,23,42,.04);overflow:hidden}.hero-proof-premium__card::before{content:"";position:absolute;left:0;right:0;top:0;height:3px;background:#059669}.hero-proof-premium__card.is-blue::before{background:#2563eb}.hero-proof-premium__card.is-amber::before{background:#d97706}.hero-proof-premium__card.is-violet::before{background:#7c3aed}.hero-proof-premium__icon{width:38px;height:38px;display:grid;place-items:center;border-radius:10px;background:#ecfdf5;color:#047857;font-size:16px;font-weight:850}.is-blue .hero-proof-premium__icon{background:#eff6ff;color:#1d4ed8}.is-amber .hero-proof-premium__icon{background:#fffbeb;color:#b45309}.is-violet .hero-proof-premium__icon{background:#f5f3ff;color:#6d28d9}.hero-proof-premium__card strong{display:block;color:#0f172a;font-size:14.5px;line-height:1.25;font-weight:750;letter-spacing:-.015em}.hero-proof-premium__card span{display:block;margin-top:4px;color:#64748b;font-size:12.5px;line-height:1.45}
