...
const midCta = `<section class="special-mid-cta" aria-label="Ön teşhis görüşmesi"><div class="wrap-wide special-mid-cta__inner"><div><strong>15 Dakikada İşletmenizin İhtiyacını ve Özel Excel Kapsamını Netleştirelim</strong><span>Mevcut dosyanızı ve yaşadığınız darboğazı iletin; hangi Excel mimarisinin çözüm üreteceğini birlikte belirleyelim.</span></div><a href="${links.mid}" target="_blank" rel="noopener noreferrer" data-event="cta_whatsapp_click" data-cta="mid_whatsapp" data-location="problem_solver">WhatsApp'tan Yazın — İhtiyacı Netleştirelim</a></div></section>`;
