...
const authorityRail = `<div class="authority-rail" aria-label="ExcelArşiv uzmanlık özeti"><div class="authority-item"><strong>90 Dk Teşhis:</strong><span>Bankanın göreceği kredi engelleri ve limit kısıtları</span></div><div class="authority-item"><strong>17 Yıl Refleks:</strong><span>Kredi komitesi ve CFO gözüyle ticari problem çözümü</span></div><div class="authority-item"><strong>ERP → CFO Kararı:</strong><span>Rapor değil; nakit, kâr ve borçlanma aksiyonu</span></div></div>`;
...
const midCta = `<section class="special-mid-cta" aria-label="Ön teşhis görüşmesi"><div class="wrap-wide special-mid-cta__inner"><div><strong>90 Dakikada Şirketinizin Kredi Engellerini ve Nakit Açığını Çıkaralım</strong><span>Kredi hazırlığı, nakit sıkışıklığı, şirket satın alma veya değerleme için Barış Bağırlar ile doğrudan görüşün.</span></div><a href="${links.mid}" target="_blank" rel="noopener noreferrer" data-event="cta_whatsapp_click" data-cta="mid_whatsapp" data-location="problem_solver">WhatsApp'tan Yazın — Teşhisi Başlatın</a></div></section>`;
