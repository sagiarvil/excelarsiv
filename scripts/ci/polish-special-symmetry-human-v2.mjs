...
if (!fs.existsSync(file)) throw new Error('SPECIAL SYMMETRY V2: build output missing');

let html = fs.readFileSync(file, 'utf8');
if (!html.includes('data-living-workbook-v1') || !html.includes('class="workbook"')) {
  console.log('SPECIAL SYMMETRY V2 SKIP — Living Workbook route not detected.');
  process.exit(0);
}
...
const replacements = [
  ...
  ['“Hangi tablo?” değil, “hangi kararı veremiyorsunuz?” diye başlarız.', 'Önce bugün işin nasıl yürüdüğünü ve nerede aksadığını dinleriz.'],
