...
// Ideal resolution: 1280x800 (16:10 ratio) 
// This scales down the 1000x1000 original to 800x800 tightly packed, enhancing sharpness and removing pixelation artifacts.
...
async function processAll() {
  ...
  for (let i = 0; i < slugs.length; i++) {
    ...
    // Pure enhancement, true to original.
  ...
  console.log(`✅ All ${slugs.length} UNIQUE images perfectly processed to WebP 1280x800!`);
}
