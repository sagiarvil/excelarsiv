...
export const productSeo: Record<string, ProductSeoEntry> = {
  '13-haftalik-nakit-akisi-ve-odeme-planlama-sistemi': { title:'13 Haftalık Nakit Akışı Excel Şablonu | Ödeme Planlama Tablosu', description:'13 haftalık nakit akış tablosunda tahsilat ve ödemeleri haftalık planlayın; nakit açığını, ödeme baskısını ve kasa dengesini formüllü Excel şablonuyla önceden görün.', primaryQuery:'13 haftalık nakit akışı excel tablosu', guideSlug:'13-haftalik-nakit-akisi-excel', guideLinkLabel:'13 haftalık nakit akışı Excel rehberini okuyun' },
  'akilli-kasa-defteri-ve-nakit-kontrol-sistemi': { title:'Kasa Defteri Excel Şablonu | Günlük Gelir Gider ve Nakit Takibi', description:'Kasa defteri Excel şablonuyla günlük nakit giriş çıkışını, kasa mevcudunu, açılış-kapanış bakiyesini ve fiili sayım farkını formüllü sistemle takip edin.', primaryQuery:'kasa defteri excel şablonu', guideSlug:'kasa-defteri-excel', guideLinkLabel:'Kasa defteri Excel rehberini okuyun' },
  'aylik-patron-finans-paneli': { title:'Şirket Finans Takip Tablosu Excel | Aylık Patron Rapor Paneli', description:'Şirket finans takip tablosu Excel üzerinde ciro, brüt kâr, nakit durumu ve alacak göstergelerini tek ekranda toplar. Yönetici finans panelini inceleyin.', primaryQuery:'şirket finans takip tablosu excel' },
  'banka-kredi-ve-taksit-takip-sistemi': { title:'Kredi Taksit Takip Excel Tablosu | Banka Kredileri ve Ödeme Takvimi', description:'Banka kredilerini, aylık taksit tarihlerini, anapara faiz dökümünü ve kalan borcu tek Excel tablosunda izleyerek ödeme takviminizi yönetin.', primaryQuery:'kredi taksit takip excel tablosu' },
  'cari-hesap-tahsilat-ve-musteri-risk-takip-sistemi': { title:'Cari Hesap Takip Excel Şablonu | Müşteri Tahsilat ve Risk Tablosu', description:'Cari hesap takip Excel şablonuyla müşteri tahsilatlarını, vadesi geçen alacakları ve risk bakiyesini izleyin; kimin ne kadar borçlu olduğunu net görün.', primaryQuery:'cari hesap takip excel şablonu', guideSlug:'cari-hesap-takip-excel', guideLinkLabel:'Cari hesap takip Excel rehberini okuyun' },
  'cek-senet-ve-vade-risk-sistemi': { title:'Çek Senet Takip Excel Tablosu | Vade ve Risk Kontrol Sistemi', description:'Çek ve senetleri vade tarihi, tutar, keşideci ve tahsilat durumuyla tek Excel tablosunda izleyin; yaklaşan ödeme ve tahsilat yoğunluğunu önceden görün.', primaryQuery:'çek senet takip excel tablosu' },
  'gunluk-gelir-gider-ve-gercek-karlilik-sistemi': { title:'Gelir Gider Tablosu Excel | Günlük Kasa ve Kârlılık Takibi', description:'Günlük gelir gider tablosunu Excel üzerinde yönetin; işletme harcamalarını, net nakit akışını ve gerçek kârlılığı kategori bazında izleyin.', primaryQuery:'gelir gider tablosu excel' },
  'kobi-finans-yonetim-paketi': { title:'KOBİ Finans Yönetimi Excel Şablonu | Nakit, Borç ve Kârlılık Tablosu', description:'KOBİ nakit akışı, cari hesap, kredi borcu, stok ve kârlılık takibini tek yapıda birleştiren profesyonel Excel finans yönetim şablonunu inceleyin.', primaryQuery:'kobi finans yönetimi excel şablonu' },
  'pos-komisyon-ve-net-tahsilat-kontrol-sistemi': { title:'POS Komisyon Hesaplama Excel | Banka Kesintisi ve Net Tahsilat', description:'POS satışlarını, banka komisyon oranlarını ve hesaba geçecek net tahsilatı Excel tablosunda karşılaştırın; erken bloke ve kesinti farkını görün.', primaryQuery:'pos komisyon hesaplama excel' },
  'proje-ve-is-bazinda-gercek-karlilik-sistemi': { title:'Proje Maliyet Takip Excel Şablonu | İş Bazında Gerçek Kârlılık', description:'Proje gelirini, malzeme ve işçilik giderlerini iş bazında Excel üzerinde takip ederek hangi projenin ne kadar kâr getirdiğini net görün.', primaryQuery:'proje maliyet takip excel şablonu' },
  'stok-satis-ve-nakit-baglanma-sistemi': { title:'Stok Takip Excel Şablonu | Giriş Çıkış, Satış ve Maliyet Tablosu', description:'Stok takip Excel şablonuyla ürün giriş çıkışını, kritik stok uyarılarını, ortalama maliyeti ve stoğa bağlanan nakdi tek sistem üzerinden izleyin.', primaryQuery:'stok takip excel şablonu', guideSlug:'stok-takip-excel', guideLinkLabel:'Stok takip Excel rehberini okuyun' },
